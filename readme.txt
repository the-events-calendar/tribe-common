...
* Feature - Requires the plugin have the `VERSION` and `VERSION_HISTORY_SLUG` constants set. `VERSION_HISTORY_SLUG` is a new constant being added specifically for these functions.  [133048]
