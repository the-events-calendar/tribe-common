...
* Tweak - Remove explicit width styles from app shop "buy now" buttons to better accommodate longer language strings (props: @abrain on GitHub for submitting this fix!) [88868]
