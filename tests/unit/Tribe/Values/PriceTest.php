...
class PriceTest extends \Codeception\Test\Unit {
	 ...
	 * @dataProvider numerical_values
	 */
	public function test_set_value_updates_all_available_formats( $value, $float, $integer, $default_currency_format ) {
		$price = new PriceClassStub( 0 );
		$price->set_value( $value );
		$this->assertEquals( $float, $price->get_float() );
		$this->assertEquals( $integer, $price->get_integer() );
		// @todo update test cases to include decimal and string formats
...
//		$this->assertEquals( $string, $price->get_string() );
	...
	public function numerical_values() {
		return [
			[ 10, 10.0, 1000, '$10.00' ],
			[ 10.0, 10.0, 1000, '$10.00' ],
			[ '10', 10.0, 1000, '$10.00' ],
			[ 'R$ 10', 10.0, 1000, '$10.00' ],
			[ 'R$10', 10.0, 1000, '$10.00' ],
			[ '$ 1.234,56', 1234.56, 123456, '$1,234.56' ],
			[ '$1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ '1,234.56 .د.م.', 1234.56, 123456, '$1,234.56' ], // this is RTL
			[ '1,234.56 ฿', 1234.56, 123456, '$1,234.56' ],
			[ '1,234.56 ₺', 1234.56, 123456, '$1,234.56' ],
			[ '1,234.56 ﷼', 1234.56, 123456, '$1,234.56' ],
			[ '1.234,56 $', 1234.56, 123456, '$1,234.56' ],
			[ '1.234,56 Ft', 1234.56, 123456, '$1,234.56' ],
			[ '1.234,56 kr', 1234.56, 123456, '$1,234.56' ],
			[ '1.234,56 Kč', 1234.56, 123456, '$1,234.56' ],
			[ '1.234,56 p.', 1234.56, 123456, '$1,234.56' ],
			[ '1.234,56 zł', 1234.56, 123456, '$1,234.56' ],
			[ '1.234,56 ₫', 1234.56, 123456, '$1,234.56' ],
			[ 'HK$ 1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ 'kr. 1.234,56', 1234.56, 123456, '$1,234.56' ],
			[ 'R.1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ 'R$ 1.234,56', 1234.56, 123456, '$1,234.56' ],
			[ 'RM 1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ '£1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ '¥ 1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ '¥ 1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ '₩ 1,234.56', 1234.56, 123456, '$1,234.56' ],
			...
			[ '₱ 1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ '₹ 1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ '元 1,234.56', 1234.56, 123456, '$1,234.56' ],
			[ '1e+3', 1000.00, 100000, '$1,000.00' ],
			[ 'abc.df', 0.0, 0, '$0.00' ],
			[ 'abcdf', 0.0, 0, '$0.00' ],
		];
	}
