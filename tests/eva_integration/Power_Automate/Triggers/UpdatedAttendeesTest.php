...
use TEC\Event_Automator\Power_Automate\Triggers\Updated_Attendees;
...
class UpdatedAttendeesTest extends \Codeception\TestCase\WPTestCase {
	 ...
	 * @test
	 */
	public function should_not_add_an_updated_woo_attendee_to_queue_when_no_access_created() {
		add_filter(
			'tec_event_automator_power_automate_enable_add_to_queue',
