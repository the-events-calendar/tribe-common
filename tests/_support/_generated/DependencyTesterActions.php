<?php  //[STAMP] ca4942417bab9d6b832347624f3b2329
...
trait DependencyTesterActions
{
     ...
     * @see \Helper\Dependency::have_plugin_with_template_and_data()
     */
    public function have_plugin_with_template_and_data($template, $data) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('have_plugin_with_template_and_data', func_get_args()));
    }
     ...
     * @see \Helper\Dependency::set_active_plugins()
     */
    public function set_active_plugins($active_plugins) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('set_active_plugins', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Dependency::get_response()
     */
    public function get_response() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('get_response', func_get_args()));
    }
