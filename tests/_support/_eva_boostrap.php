...
// TEC Test Support.
$tec_dir         = dirname( __DIR__, 4 ) . '/the-events-calendar';
...
// ET Test Support.
$et_dir         = dirname( __DIR__, 4 ) . '/event-tickets';
...
// ET+ Test Support.
$etplus_dir         = dirname( __DIR__, 4 ) . '/event-tickets-plus';
 ...
 * autoloading.
 */
//require_once $tec_support_dir . '/Helper/TECDb.php';

Autoload::addNamespace( '\\Tribe\\Events\\Test', $tec_support_dir );
Autoload::addNamespace( '\\Helper', $tec_support_dir );
Autoload::addNamespace( '\\TEC\\Event_Automator\\Tests', dirname( __DIR__, 1 ) . '/_support' );
Autoload::addNamespace( '\\Tribe\\Extensions', dirname( __DIR__, 1 ) . '/_data/classes/Tribe/Extensions' );
