        ...
        <tr valign="top">
            ...
            <td>
                <label for="ea_mocker-import_id">
                    Enter the full URL of the server that should be hit by requests; this includes the HTTP scheme; e.g. <code>https://ea.dev</code>. Leave it blank to avoid mocking.
                    <div class="inline">
                        <input type="text" value="<?php echo get_option('ea_mocker-service_domain') ?>" name="ea_mocker-service_domain"
