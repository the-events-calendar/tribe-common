...
class UpdatedAttendeeCest extends BaseRestCest {
	 ...
	 * @inheritdoc
	 */
	protected static $current_test_url = 'updated-attendees';
	...
	public function it_should_return_valid_with_access_token_contains_verified_api_key_pair_and_last_access_is_updated( Restv1Tester $I ) {
		...
		$endpoint_details = get_option( '_tec_zapier_endpoint_details_updated_attendees' );
	 ...
	 * @test
	 */
	public function it_should_process_updated_attendees_queue( Restv1Tester $I ) {
	...
	public function it_should_return_404_when_endpoint_disabled( Restv1Tester $I ) {
		...
		$this->disable_endpoint( $I, '_tec_zapier_endpoint_details_updated_attendees', $endpoint );
		$this->setup_api_key_pair( $I );
		$I->sendGET( $this->updated_attendees_url, [ 'access_token' => static::$valid_access_token ] );
