...
class OrdersCest extends BaseRestCest {
	 ...
	 * @inheritdoc
	 */
	protected static $current_test_url = 'orders';
...
/*		$order_ids[] = 'no-new-sales';
	...
	/**
	 * @test
	 * @skip TC cart does not clear between tests causing, "Trying to access array offset on value of type null".sli
	 */
	...
	public function it_should_return_404_when_endpoint_disabled( Restv1Tester $I ) {
		...
		$this->disable_endpoint( $I, '_tec_zapier_endpoint_details_orders', $endpoint );
		$this->setup_api_key_pair( $I );
		$I->sendGET( $this->orders_url, [ 'access_token' => static::$valid_access_token ] );
