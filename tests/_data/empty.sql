...
CREATE TABLE `wptests_edd_notifications` (
  ...
  `content` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `buttons` longtext COLLATE utf8mb4_unicode_ci,
  `type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'success',
  `conditions` longtext COLLATE utf8mb4_unicode_ci,
  `start` datetime DEFAULT NULL,
  `end` datetime DEFAULT NULL,
  `dismissed` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
-- Dump completed on 2025-09-25 15:12:38
