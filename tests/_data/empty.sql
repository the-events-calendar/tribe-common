...
INSERT INTO `wp_actionscheduler_actions` VALUES (2,'action_scheduler/migration_hook','complete','2022-09-06 10:31:49','2022-09-06 10:31:49','[]','O:30:\"ActionScheduler_SimpleSchedule\":2:{s:22:\"\0*\0scheduled_timestamp\";i:1662460309;s:41:\"\0ActionScheduler_SimpleSchedule\0timestamp\";i:1662460309;}',1,1,'2022-09-06 11:51:24','2022-09-06 11:51:24',0,NULL);
...
INSERT INTO `wp_actionscheduler_logs` VALUES (1,2,'action created','2022-09-06 10:30:49','2022-09-06 10:30:49'),(2,2,'action started via Async Request','2022-09-06 11:51:24','2022-09-06 11:51:24'),(3,2,'action complete via Async Request','2022-09-06 11:51:24','2022-09-06 11:51:24');
...
INSERT INTO `wptests_actionscheduler_actions` VALUES (5,'action_scheduler/migration_hook','pending','2024-03-29 09:59:30','2024-03-29 09:59:30',10,'[]','O:30:\"ActionScheduler_SimpleSchedule\":2:{s:22:\"\0*\0scheduled_timestamp\";i:1711706370;s:41:\"\0ActionScheduler_SimpleSchedule\0timestamp\";i:1711706370;}',1,0,'0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL);
...
INSERT INTO `wptests_actionscheduler_groups` VALUES (1,'action-scheduler-migration');
...
INSERT INTO `wptests_actionscheduler_logs` VALUES (1,5,'action created','2024-03-29 09:58:30','2024-03-29 09:58:30');
...
CREATE TABLE `wptests_posts` (
  ...
  KEY `post_parent` (`post_parent`),
  KEY `post_author` (`post_author`)
) ENGINE=InnoDB AUTO_INCREMENT=926 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wptests_users` VALUES (1,'admin','$P$B6w39lFJVCOqw2R5PXVo3BHvOLGhCB1','admin','admin@wordpress.test','http://wordpress.test','2024-03-29 10:24:06','',0,'admin');
...
-- Dump completed on 2024-03-29 10:33:12
