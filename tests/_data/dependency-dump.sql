...
CREATE TABLE `wp_edd_order_items` (
  ...
  `date_modified` datetime NOT NULL DEFAULT '',
  `uuid` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2024-07-16 19:40:51
