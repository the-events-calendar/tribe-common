<?php
	...
	$fs_text = array(
		...
		'squid-sysadmin-desc'                      => _fs_text( 'Great, please add the following domains: %s to your safe list. Once you are done, deactivate the %s and activate it again.' ),
		...
		'fix-issue-desc'                           => _fs_text( 'We will do our best to add your server to the safe list and resolve this issue ASAP. You will get a follow-up email to %s once we have an update.' ),
		...
		'server-blocking-access'                   => _fs_x( 'Your server is blocking the access to Freemius\' API, which is crucial for %1$s synchronization. Please contact your host to add %2$s to your safe list',
