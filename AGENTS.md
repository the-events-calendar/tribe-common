...
- Version placeholders in docblocks are the literal `6.12.4`: `@since 6.12.4`,
  `@deprecated 6.12.4`, `_deprecated_function( __METHOD__, '6.12.4' )`. The release
  workflow replaces them with the version being shipped. Never write a real
  version number there, and do not flag `6.12.4` as an unfinished placeholder.
