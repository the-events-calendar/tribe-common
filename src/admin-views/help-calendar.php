		...
		<?php foreach ( $calendar_products as $slug ) : ?>
			...
			<div class="tribe-events-admin-card tribe-events-admin-card--product tribe-events-admin-card--2up tribe-events-admin-card--<?php echo $i%2 ? 'first' : 'second';?>">
				...
				<div class="tribe-events-admin-card__group">
					<div class="tribe-events-admin-card__title"><?php echo esc_html( $products[ $slug ]['title'] ); ?></div>
					<div class="tribe-events-admin-card__description"><?php echo esc_html( $products[ $slug ]['description-help'] ); ?></div>
				</div>
				<?php if ( $products[ $slug ]['is_installed'] ) : ?>
				<button class="tribe-events-admin-card__button tribe-events-admin-ard__button--active"><?php esc_html_e( 'Active', 'tribe-common' ); ?></button>
				<?php else : ?>
