...
<div class="tec-settings-form__content-section">
	...
	<ul class="tec-help-list__list-expanded">
		<li>
			<img class="tec-help-list__icon-expanded" src="<?php echo esc_url( $icons['tec_icon_url'] ); ?>"/>
		...
		<li>
			<img class="tec-help-list__icon-expanded" src="<?php echo esc_url( $icons['ea_icon_url'] ); ?>"/>
		...
		<li>
			<img class="tec-help-list__icon-expanded" src="<?php echo esc_url( $icons['fbar_icon_url'] ); ?>"/>
