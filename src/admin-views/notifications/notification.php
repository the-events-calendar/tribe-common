...
<div class="ian-sidebar__notification ian-sidebar__notification--<?php echo esc_attr( $type ); ?>" id="notification_<?php echo esc_attr( $id ); ?>" data-nonce="<?php echo esc_attr( wp_create_nonce( 'ian_nonce_' . $id ) ); ?>">
	<?php if ( $dismissible ) : ?>
	<div class="dashicons dashicons-dismiss" data-trigger="dismissIan" data-id="<?php echo esc_attr( $id ); ?>" data-slug="<?php echo esc_attr( $slug ); ?>" title="<?php esc_attr_e( 'Dismiss', 'tribe-common' ); ?>"></div>
	<?php endif; ?>
	...
	<div class="ian-sidebar__notification-link">
		...
		<div class="ian-sidebar__notification-link--right">
			<?php if ( ! $read ) : ?>
				<a href="#" data-trigger="readIan" data-id="<?php echo esc_attr( $id ); ?>" data-slug="<?php echo esc_attr( $slug ); ?>"><?php esc_html_e( 'Mark as read', 'tribe-common' ); ?></a>
			<?php endif; ?>
		</div>
	</div>
	<?php endif; ?>
