...
<div class="tec_settings__header-block tec_settings__header-block--horizontal">
	...
	<h3 id="tec-power-automate-application-credentials" class="tec-settings-power-automate-application__title tec-settings__section-header tec-settings__section-header--sub">
