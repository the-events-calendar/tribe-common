...
?>
<fieldset id="tec-field-zapier_token" class="tec-automator-api-fields tribe-field tribe-field-text tribe-size-medium tec-settings__element--colspan-2">
	...
	<div class="tec-zapier-add-wrap">
		<?php
		$this->template(
			'zapier/api/authorize-fields/add-link',
			[
				'api' => $api,
				'url' => $url,
			]
