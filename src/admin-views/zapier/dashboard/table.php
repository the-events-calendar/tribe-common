...
<fieldset id="tec-field-zapier_token" class="tec-automator-endpoint-dashboard tribe-field tribe-field-text tribe-size-medium">
	<legend class="tribe-field-label"><?php echo esc_html_x( 'Endpoint Dashboard', 'The legend for the Zapier endpoint dashboard.','event-automator' ); ?></legend>
	...
	<div class="tec-automator-settings-items__wrap tec-zapier-endpoint-dashboard-wrap event-automator">
		<?php
		$this->template( 'zapier/dashboard/endpoints/list', [
			'endpoints' => $endpoints,
			'manager'   => $manager,
			'url'       => $url,
		] );
