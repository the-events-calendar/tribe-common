...
<div
	class="tec-automator-grid tec-automator-grid-row tec-automator-endpoint-dashboard-grid tec-automator-settings-details__container tec-settings-connection-endpoint-dashboard-details__container"
	data-endpoint-id="<?php echo esc_attr( $endpoint['id'] ); ?>"
>
	<?php
	...
	<?php
		...
		if ( $endpoint['enabled'] && ! $endpoint['missing_dependency'] ) {
			...
			$this->template( 'zapier/dashboard/components/disabled', [
				'classes_wrap'  => $last_access_classes,
				'label'         => $last_access_label,
