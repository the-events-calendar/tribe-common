...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar PRO', 'tribe-common' ),
	/**
...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar: Eventbrite Tickets', 'tribe-common' ),
	/**
...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar: Community Events', 'tribe-common' ),
	/**
...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar: Facebook Events', 'tribe-common' ),
	/**
...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar: WooCommerce Tickets', 'tribe-common' ),
	/**
...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar: EDD Tickets', 'tribe-common' ),
	/**
...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar: WPEC Tickets', 'tribe-common' ),
	/**
...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar: Shopp Tickets', 'tribe-common' ),
	/**
...
$premium_add_ons[] = array(
	'title' => esc_html__( 'The Events Calendar: Filter Bar', 'tribe-common' ),
	/**
...
$getting_started_text = esc_html__( "If you're looking for help with The Events Calendar, you've come to the right place. We are committed to helping make your calendar be spectacular... and hope the resources provided below will help get you there.", 'tribe-common' );
...
$intro_text[] = '<ul>';
$intro_text[] = '<li>';
$intro_text[] = sprintf( esc_html__( '%sOur New User Primer%s was designed for folks in your exact position. Featuring both step-by-step videos and written walkthroughs that feature accompanying screenshots, the primer aims to take you from zero to hero in no time.', 'tribe-common' ), '<a href="' . esc_url( Tribe__Main::$tec_url . 'knowledgebase/new-user-primer-the-events-calendar-and-events-calendar-pro/' . $ga_query_string ) . '" target="blank">', '</a>' );
$intro_text[] = '</li><li>';
...
$support_text[] = '<p>' . sprintf( esc_html__( "We've redone our support page from the ground up in an effort to better help our users. Head over to our %sSupport Page%s and you'll find lots of great resources, including:", 'tribe-common' ), '<a href="' . esc_url( Tribe__Main::$tec_url . 'support/' . $ga_query_string ) . '" target="blank">', '</a>' ) . '</p>';
$support_text[] = '<ul><li>';
...
$support_text[] = '</li><li>';
$support_text[] = sprintf( esc_html__( '%sFrequently Asked Questions%s ranging from the most basic setup questions to advanced themer tweaks', 'tribe-common' ), '<a href="' . esc_url( Tribe__Main::$tec_url . 'knowledgebase/' . $ga_query_string ) . '" target="blank">', '</a>' );

$support_text[] = '</li><li>';
$support_text[] = sprintf( esc_html__( '%sTutorials%s written by both members of our team and users from the community, covering custom queries, integration with third-party themes and plugins, etc.', 'tribe-common' ), '<a href="' . esc_url( Tribe__Main::$tribe_url . 'the-events-calendar-for-wordpress-tutorials/' . $ga_query_string ) . '" target="blank">', '</a>' );
$support_text[] = '</li><li>';
...
$support_text[] = '</li><li>';
$support_text[] = sprintf( esc_html__( "%sAdd-on documentation%s for all of Modern Tribe's official extensions for The Events Calendar (including WooTickets, Community Events, Eventbrite Tickets, Facebook Events, etc)", 'tribe-common' ), '<a href="' . esc_url( Tribe__Main::$tec_url . 'knowledgebase-category/primers/' ) . '" target="blank">', '</a>' );
$support_text[] = '</li></ul>';
