...
if ( ! function_exists( 'tribe_can_plugin_run' ) ) {
	/**
	 ...
	 */
	function tribe_can_plugin_run( $file_path, $main_class, $version, $classes_req = array() ) {
		$tribe_plugins = Tribe__Plugin_Dependencies::instance();
