...
class Stellar_Sale extends Promotional_Content_Abstract {
	...
	protected function get_link_url(): string {
		return 'https://theeventscalendar.com/stellar-sale?utm_source=activecampaign&utm_medium=in-app-banner&utm_campaign=stellarsale25';
	}
		...
		return [
			'events'  => [
				'events-calendar-pro/events-calendar-pro.php'                       => [
					...
					'link_url'         => 'https://theeventscalendar.com/products/wordpress-events-calendar/?utm_source=activecampaign&utm_medium=in-app-banner&utm_campaign=stellarsale25',
					'alt_text'         => sprintf(
				...
				'the-events-calendar-filterbar/the-events-calendar-filter-view.php' => [
					...
					'link_url'         => 'https://theeventscalendar.com/products/wordpress-calendar-filter-bar/?utm_source=activecampaign&utm_medium=in-app-banner&utm_campaign=stellarsale25',
					'alt_text'         => sprintf(
						/* translators: %1$s: Sale year (numeric), %2$s: Sale name */
			...
			'tickets' => [
				'event-tickets-plus/event-tickets-plus.php' => [
					...
					'link_url'          => 'https://theeventscalendar.com/products/wordpress-event-tickets/?utm_source=activecampaign&utm_medium=in-app-banner&utm_campaign=stellarsale25',
					'alt_text'          => sprintf(
						/* translators: %1$s: Sale year (numeric), %2$s: Sale name */
				...
				'seating-check'                             => [
					...
					'link_url'          => 'https://theeventscalendar.com/products/seating/?utm_source=activecampaign&utm_medium=in-app-banner&utm_campaign=stellarsale25',
					'alt_text'          => sprintf(
						/* translators: %1$s: Sale year (numeric), %2$s: Sale name */
