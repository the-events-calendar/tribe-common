...
class AI_Service {
	...
	/**
	 * Get the REST namespace for calendar endpoints.
	 *
	 * @since TBD
	 *
	 * @return string The REST namespace.
	 */
	protected function get_rest_namespace(): string {
		// Allow The Events Calendar to override the namespace.
		if ( tribe()->has( 'tec.rest-v1.main' ) ) {
			return tribe( 'tec.rest-v1.main' )->get_events_route_namespace();
		}

		// Default namespace.
		return 'tribe/events/v1';
	}
	...
	public function get_tool_definitions(): array {
		...
		$default_path = tribe( 'common.main' )->plugin_path . 'src/includes/integration-plugin-mcp-ai-service.php';
