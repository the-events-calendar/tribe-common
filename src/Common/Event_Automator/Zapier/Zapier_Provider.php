...
class Zapier_Provider extends Service_Provider {
	 ...
	 *
	 * @since 6.0.0 Migrated to Common from Event Automator
	 * @deprecated TBD - Use Tribe\Events\Pro\Integrations\Event_Automator\Zapier_Provider->pre_dispatch_verification_for_create_events
	 *
	...
	public function pre_dispatch_verification( $result, $server, $request ) {
		_deprecated_function( __METHOD__, 'TBD', 'Use Tribe\Events\Pro\Integrations\Event_Automator\Zapier_Provider->pre_dispatch_verification_for_create_events instead.' );
	 ...
	 *
	 * @since 6.0.0 Migrated to Common from Event Automator
	 * @deprecated TBD - Use Tribe\Events\Pro\Integrations\Event_Automator\Zapier_Provider->pre_dispatch_verification_for_update_events
	 *
	 * @param mixed           $result  Response to replace the requested version with. Can be anything
	 *                                 a normal endpoint can return, or null to not hijack the request.
	 * @param WP_REST_Server  $server  Server instance.
	...
	public function pre_dispatch_verification_for_update_events( $result, $server, $request ) {
		_deprecated_function( __METHOD__, 'TBD', 'Use Tribe\Events\Pro\Integrations\Event_Automator\Zapier_Provider->pre_dispatch_verification_for_update_events instead.' );
	 ...
	 *
	 * @since 6.0.0 Migrated to Common from Event Automator
	 * @deprecated TBD - Use Tribe\Tickets\Plus\Integrations\Event_Automator\Zapier_Provider->pre_dispatch_verification_for_find_attendees
	 *
	 * @param mixed           $result  Response to replace the requested version with. Can be anything
	 *                                 a normal endpoint can return, or null to not hijack the request.
	 * @param WP_REST_Server  $server  Server instance.
	...
	public function pre_dispatch_verification_for_find_attendees( $result, $server, $request ) {
		_deprecated_function( __METHOD__, 'TBD', 'Use Tribe\Tickets\Plus\Integrations\Event_Automator\Zapier_Provider->pre_dispatch_verification_for_find_attendees instead.' );
	 ...
	 *
	 * @since 6.0.0 Migrated to Common from Event Automator
	 * @deprecated TBD - Use Tribe\Tickets\Plus\Integrations\Event_Automator\Zapier_Provider->pre_dispatch_verification_for_find_tickets
	 *
	 * @param mixed           $result  Response to replace the requested version with. Can be anything
	 *                                 a normal endpoint can return, or null to not hijack the request.
	 * @param WP_REST_Server  $server  Server instance.
	...
	public function pre_dispatch_verification_for_find_tickets( $result, $server, $request ) {
		_deprecated_function( __METHOD__, 'TBD', 'Use Tribe\Tickets\Plus\Integrations\Event_Automator\Zapier_Provider->pre_dispatch_verification_for_find_tickets instead.' );
	 ...
	 *
	 * @since 6.0.0 Migrated to Common from Event Automator
	 * @deprecated TBD - Use Tribe\Events\Pro\Integrations\Event_Automator\Zapier_Provider->modify_rest_api_params_before_validation
	 *
	...
	public function modify_rest_api_params_before_validation( $response, $server, $request ) {
		_deprecated_function( __METHOD__, 'TBD', 'Use Tribe\Events\Pro\Integrations\Event_Automator\Zapier_Provider->modify_rest_api_params_before_validation instead.' );
	 ...
	 *
	 * @since 6.0.0 Migrated to Common from Event Automator
	 * @deprecated TBD - Use Tribe\Events\Pro\Integrations\Event_Automator\Zapier_Provider->modify_rest_api_params_before_validation_for_update_events
	 *
	 * @param WP_REST_Response|WP_Error $response Response to replace the requested version with. Can be anything
	 *                                            a normal endpoint can return, or a WP_Error if replacing the
	 *                                            response with an error.
	...
	public function modify_rest_api_params_before_validation_for_update_events( $response, $server, $request ) {
		_deprecated_function( __METHOD__, 'TBD', 'Use Tribe\Events\Pro\Integrations\Event_Automator\Zapier_Provider->modify_rest_api_params_before_validation_for_update_events instead.' );
