...
use TEC\Common\Event_Automator\Power_Automate\Triggers\Refunded_Orders as Trigger_Refunded_Orders;
use WP_REST_Server;
use WP_REST_Request;
...
class Refunded_Orders extends Abstract_REST_Endpoint {
	...
	protected function get_display_name() : string {
		return _x( 'Refunded Orders', 'Display name of the Power Automate endpoint for refunded ticket orders.', 'event-automator' );
	}
