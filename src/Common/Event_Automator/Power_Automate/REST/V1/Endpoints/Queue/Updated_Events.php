...
class Updated_Events extends Abstract_REST_Endpoint {
	...
	protected function get_display_name() : string {
		return _x( 'Updated Events', 'Display name of the Power Automate endpoint for updated events.', 'tribe-common' );
	}
	...
	public function get_documentation() {
		...
		return [
			'post' => [
				...
				'responses'  => [
					'201' => [
						'description' => _x( 'Returns successful checking of the updated event queue.', 'Description for the Power Automate Updated Event REST endpoint on a successful return.', 'tribe-common' ),
						'schema'      => [
							'$ref' => '#/definitions/Power_Automate',
						],
					],
					'400' => [
						'description' => _x( 'A required parameter is missing or an input parameter is in the wrong format', 'Description for the Power Automate Updated Event REST endpoint missing a required parameter.', 'tribe-common' ),
					],
				],
			],
		];
	...
	public function READ_args() {
		return [
			'access_token' => [
				...
				'type'              => 'string',
				'description'       => _x( 'The access token to authorize Power Automate connection.', 'Description for the Power Automate Updated Event REST endpoint required parameter.', 'tribe-common' ),
			],
		];
	}
}
