	...
	class Tribe__View_Helpers {
		...
		public static function getHourOptions( $date = '', $isStart = false ) {
			...
			if ( empty( $date ) ) {
				...
				$hour      = Tribe__Date_Utils::build_date_object( $date, 'UTC' )->format( $h );
		...
		public static function getMinuteOptions( $date = '', $isStart = false ) {
			...
			if ( empty( $date ) ) {
				...
				$minute = Tribe__Date_Utils::build_date_object( $date, 'UTC' )->format( 'i' );
			}
		...
		public static function getMeridianOptions( $date = '', $isStart = false ) {
			...
			if ( empty( $date ) ) {
				...
				$meridian = Tribe__Date_Utils::build_date_object( $date, 'UTC' )->format( $a );
			}
