...
if (! class_exists('Tribe__Troubleshooting')) {
    /**
     * Class that handles the integration with our Shop App API
     */
    class Tribe__Troubleshooting
    {
         ...
         * Singleton instance
         *
         * @var null or Tribe__Troubleshooting
         */
        ...
        protected function register_assets()
        {
            tribe_assets(
                ...
                [
                    [ 'tribe-troubleshooting-css', 'troubleshooting.css' ],
                    [ 'tribe-troubleshooting-js', 'troubleshooting.js', [ 'jquery' ] ],
                ],
