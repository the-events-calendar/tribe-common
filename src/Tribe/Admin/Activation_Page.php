...
class Tribe__Admin__Activation_Page {
	...
	public function display_page() {
		...
		// phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped, StellarWP.XSS.EscapeOutput.OutputNotEscaped -- $title is escaped above; $html is a rendered admin view.
		echo "
