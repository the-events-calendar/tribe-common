...
class Tribe__Admin__Notice__Php_Version {
	...
	public function get_active_plugins() {
		...
		$active_plugins = $dependency->get_active_plugins();
	...
	/**
	 * We only want to display notices for users who are on PHP < 7.4.
	 *
	 * @since 4.7.16
	 *
	 * @return boolean Whether to display the notice.
	 */
	 ...
	 * @since 4.7.16
	 *
	 * @return string The HTML for the PHP notice.
	 */
