...
class Settings {
	...
	/**
	 * Logic to load generic settings assets.
	 *
	 * @since 5.0.0
	 *
	 * @return bool
	 */
	public function should_load_settings_assets() {
		/**
		 * Filters whether or not we should load the generic settings assets on the settings page.
		 *
		 * @since TBD
		 *
		 * @param boolean  $return  True or false whether to load assets.
		 */
		$load_assets = apply_filters( 'tec_admin_settings_assets', false );
