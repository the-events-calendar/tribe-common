...
class Tribe__Main {
	...
	public function init_libraries() {
		...
		require_once $this->plugin_path . 'src/functions/post.php';
	...
	public function load_assets() {
		...
		tribe_assets(
			...
			array(
				...
				array( 'tribe-handlebars', 'vendor/handlebars/handlebars.js' ),
				...
				array( 'tribe-handlebars-utils', 'tribe-handlebars-utils.js', array( 'tribe-handlebars' ) ),
				array( 'tribe-utils-camelcase', 'utils-camelcase.js', array( 'underscore' ) ),
		...
		tribe_assets(
			...
			array(
				...
				array( 'tribe-validation', 'validation.js', array( 'jquery', 'underscore', 'tribe-handlebars', 'tribe-common', 'tribe-utils-camelcase' ) ),
