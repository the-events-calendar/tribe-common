 ...
 * @return {boolean} true if the value is a valid "true" value.
 */
export const isTruthy = ( value ) => {
	const validValues = [ 'true', 'yes', '1' ];
 ...
 *
 * @param {string} value The value to be tested
 * @return {boolean} true if the value is a valid "false" value.
 */
export const isFalsy = ( value ) => {
	const validValues = [ 'false', 'no', '0', '' ];
	return validValues.indexOf( value ) !== -1;
};
 ...
 * @return {Array} Return an array with the words
 */
 ...
 * @return {string} return a string with custom separators between words
 */
 ...
 * @return {string} A formatted string with no spacing and only a-z chars
 */
