 ...
 * @return {function(*): *} Returns a function that takes a Component as argument and returns a component.
 */
export default ( getName = noop ) =>
	( WrappedComponent ) => {
		class WithForm extends Component {
			...
			additionalProps() {
				const { createDraft, sendForm, setSubmit, editEntry, maybeRemoveEntry } = this.props;
				const name = getName( this.props );
				return {
